...
<script setup>
    ...
    onMounted(async () => {
        ...
        try {
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/server/products/${productId}`);
    ...
    const fetchReviews = async (productId) => {
        ...
        try {
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/server/reviews/${productId}`);
